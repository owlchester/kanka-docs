...
Every other category has an **Abilities** subpage, which is used for example to keep track of a character's magic, an organisation's special abilities, a locations' _lair actions_, a family's curse, etc.
...
![Entry Abilities](img/entity-abilities.png)
...
The **Add race abilities** will import abilities attached to the entry's [races](/entries/races).
...
![Form to define a note on the entry ability](img/entity-ability-note-1.png)

![Displaying an entry ability note](img/entity-ability-note-2.png)
