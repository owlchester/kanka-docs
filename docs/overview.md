...
Kanka comes with a flexible set of predefined [categories](/entries/overview) that can be customised and linked to each other. The [characters](/entries/characters) category allows you to create the people that populate your world by giving them names, images, descriptions, have them placed in [locations](/entries/locations), be members of [families](/entries/families) and join [organisations](/entries/organisations) that share their motivations. You can also set up their physical and personality traits, their goals, fears, motivations and secrets.

All entries can have [relations](/features/relations) that help define how they view other entries in the world. You can easily set up childhood friends between characters, rivalling factions between organisations and families, and catalysts between events.
...
To organise everything, you can tag every entry with multiple [tags](/entries/tags). These can be used to quickly find relevant information, or used as filters on the various interfaces.

Kanka's flexibility doesn't stop there. If you have no use for the families or quests, you can [disable them](/features/campaigns/categories) in your campaign settings, removing them from the various interfaces. You can also [export](/features/campaigns/export) all of your campaign's data once per day if you are ever scared of losing everything. But don't worry, we do frequent backups of all of your data anyway.
