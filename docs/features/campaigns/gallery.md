...
* **Browse**, which grants members of the role access to the gallery without being able to add, edit or delete images. They can still select images from the gallery to add to entries through the text editor.
